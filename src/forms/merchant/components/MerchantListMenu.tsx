...
export interface BaseMerchantListMenuProps {
  classes: any
  top?: string
}
...
export class BaseMerchantListMenu extends React.Component<BaseMerchantListMenuProps & WithStyles<typeof styles>, {}> {
  ...
  renderMobileMenu = () => {
    ...
    return (
      ...
      >
        <MenuItem>{this.renderAddButton(true)}</MenuItem>
        <MenuItem>
          <IconButton color="inherit">
            <DeleteIcon />
          </IconButton>
          <p>Delete merchants</p>
        </MenuItem>
      </Menu>
    )
  }
...
export const MerchantListMenu = withStyles(styles)(BaseMerchantListMenu)
